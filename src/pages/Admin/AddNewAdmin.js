    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="px-6 py-4 bg-red-800 text-white">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex justify-end space-x-4 pt-6 border-t">
                <button
                  ...
                  onClick={resetForm}
                  disabled={isSubmitting}
                  className="px-6 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-6 py-2 bg-red-800 text-white rounded-md hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <p className="text-sm text-yellow-700">
            ...
            <code className="bg-yellow-100 px-1 rounded">getAuthToken()</code>{" "}
