              ...
              <div className="p-6">
                ...
                <div className="flex justify-end mt-6 pt-4 border-t border-gray-100">
                  <button
                    ...
                    className="flex items-center text-red-600 hover:text-red-800 transition-colors duration-200 hover:bg-red-50 px-3 py-2 rounded-lg"
                  >
            ...
            <div className="p-6">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                >
                  {deleteLoading ? (
                    <>
                ...
                <button
                  ...
                  disabled={deleteLoading}
                  className="flex-1 bg-gray-200 hover:bg-gray-300 disabled:bg-gray-100 text-gray-800 py-3 rounded-lg font-medium transition-colors duration-200"
                >
                  Cancel
                </button>
              </div>
