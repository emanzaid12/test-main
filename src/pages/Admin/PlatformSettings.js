      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8 border border-gray-200">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <div className="flex items-center">
              <FaPercent className="text-red-600 text-3xl mr-4" />
              {firstOrderDiscount.isEditing ? (
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      disabled={loading}
                      className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors duration-200 disabled:opacity-50"
                    >
                      <FaCheck className="mr-2" />
                      Save
                    </button>
                    <button
                      ...
                      disabled={loading}
                      className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors duration-200 disabled:opacity-50"
                    >
                      <FaTimes className="mr-2" />
                      Cancel
                    </button>
                    ...
                    {level.isEditing ? (
                      <div className="flex items-center mt-1">
                        <input
                          ...
                          className="border border-gray-300 rounded-lg px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-red-500"
                          min="0"
                          max="100"
                        />
                  ...
                  {level.isEditing && (
                    <div className="flex space-x-2 mt-4">
                      <button
                        ...
                        disabled={loading}
                        className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded-lg flex items-center text-sm transition-colors duration-200 flex-1 disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="bg-gray-600 hover:bg-gray-700 text-white px-3 py-1 rounded-lg flex items-center text-sm transition-colors duration-200 flex-1 disabled:opacity-50"
                      >
              ...
              {shippingCost.isEditing ? (
                <div className="flex items-center space-x-4">
                  <input
                    ...
                    className="border border-gray-300 rounded-lg px-4 py-2 text-2xl font-bold w-32 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    min="0"
                    step="0.01"
                  />
                  <div className="flex space-x-2">
        ...
        <div className="bg-gradient-to-r from-red-50 to-purple-50 rounded-xl p-6 border border-red-200">
          <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
            <FaSave className="text-red-600 mr-2" />
